...
font {
 ...
 <script type="text/javascript">
	//点击切换img中的验证码图片
 	function fn1(obj){
 		obj.src="/Shop01/vcodeServlet?time="+new Date()
 	}
	
	function fn2(obj){
		$.get("${pageContext.request.contextPath}/checkName?username="+obj.value,function(result){
			//result就是响应数据
			//将响应数据，显示到span中
			$("#sp").text(result)
		})
		...
		<form class="form-horizontal" style="margin-top:5px;" method="post" action="${pageContext.request.contextPath }/userServlet">
			<input type="hidden" name="method" value="regist">
			 <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="username" placeholder="请输入用户名" name="username" onblur="fn2(this)">
			    </div>
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			    <img src="/Shop01/vcodeServlet" onclick="fn1(this)"/>
			    </div>
			    <span style="color:red">${vmsg }</span>
