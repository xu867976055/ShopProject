			...
			<div class="container-fluid">
				...
				<c:forEach items="${hotList }" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath}/productServlet?method=findByPid&pid=${p.pid }">${fn:substring(p.pname, 0, 12)}...</a></p>
			...
			<div class="container-fluid">
				...
				<c:forEach items="${newList }" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath}/productServlet?method=findByPid&pid=${p.pid }" style='color:#666'>${fn:substring(p.pname, 0, 12)}...</a></p>
						<p><font color="#E4393C" style="font-size:16px">&yen;${p.shop_price }</font></p>
					</div>
				</c:forEach>
				</div>
