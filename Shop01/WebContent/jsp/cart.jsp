	 ...
	 float:left; */
		...
		<script type="text/javascript">
			function delByPid(pid){
				...
				if(result){
					//同意删除商品
					location.href="${pageContext.request.contextPath}/cartServlet?method=delete&pid="+pid
				}
			}
		</script>
	</head>
					...
					<div style="margin:0 auto; margin-top:10px;width:950px;">
						...
						<table class="table table-bordered">
							<tbody>
								...
								<!-- 拿到购物车map集合,遍历,cart.values是javabean属性 -->
							<c:forEach items="${cart.values }" var="c">
								<tr class="active">
									...
									<td width="10%">
										<input type="text" name="quantity" value="${c.count}" maxlength="4" size="10" disabled="disabled">
									</td>
									<td width="15%">
										<span class="subtotal">￥${c.subTotal }</span>
									</td>
									<td>
										<a href="javascript:void(0);" class="delete" onclick="delByPid('${c.product.pid}')">删除</a>
